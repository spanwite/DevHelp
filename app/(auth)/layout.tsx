...
export default function AuthLayout({
  ...
  return (
    <main
      className={cn(
        'relative flex min-h-screen items-center justify-center overflow-hidden p-2.5 xs:p-6'
      )}
    >
      <div className='*:pointer-events-none *:-z-10'>
        <div className='bg-auth absolute inset-0 bg-cover bg-center bg-no-repeat opacity-20 dark:opacity-20 max-xs:hidden' />
        <div
